...
func main() {
	...
	user := User{
		...
		Username:      "demo",
		PasswordHash:  "$2a$10$RCU6LUYCUSbI6RBqLVQYHu9x4XFTImJwc6Bli0ZbirmSY7T//6yv.", // password: "passw0rd!"
		FullName:      "Demo User",
		FamilySize:    2,
		EmailVerified: true,
		CreatedAt:     time.Now(),
	...
	budgetItems := []BudgetItem{
		{ID: primitive.NewObjectID(), CategoryID: expenseCategories[0].ID, CategoryName: "Food & Dining", PlannedAmount: 8000000.00, SpentAmount: 6500000.00},
		{ID: primitive.NewObjectID(), CategoryID: expenseCategories[1].ID, CategoryName: "Transportation", PlannedAmount: 3000000.00, SpentAmount: 2800000.00},
		{ID: primitive.NewObjectID(), CategoryID: expenseCategories[2].ID, CategoryName: "Shopping", PlannedAmount: 5000000.00, SpentAmount: 4200000.00},
		{ID: primitive.NewObjectID(), CategoryID: expenseCategories[3].ID, CategoryName: "Entertainment", PlannedAmount: 2000000.00, SpentAmount: 1500000.00},
		{ID: primitive.NewObjectID(), CategoryID: expenseCategories[4].ID, CategoryName: "Bills & Utilities", PlannedAmount: 4000000.00, SpentAmount: 3800000.00},
	}
	...
	for month := 0; month < 3; month++ {
		...
		for _, incomeCategory := range incomeCategories {
			if incomeCategory.Name == "Salary" {
				// Ensure salary date is not in future
				salaryDate := monthStart.AddDate(0, 0, 1)
				if salaryDate.After(time.Now()) {
					continue
				}
	...
	fmt.Printf("- 1 demo user (email: demo@gspend.com, password: passw0rd!)\n")
