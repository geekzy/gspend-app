<template>
  <MainLayout>
    <div class="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
      ...
      <div v-else-if="incomes.length === 0"
        ...
        <div class="bg-white rounded-3xl w-full max-w-md p-8 shadow-2xl animate-in fade-in zoom-in duration-200">
          ...
          <form @submit.prevent="handleAddIncome" class="space-y-4">
            <div>
              ...
              <input v-model="newIncome.source" type="text"
                class="w-full px-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input v-model.number="newIncome.amount" type="number" step="0.01"
                  class="w-full pl-8 pr-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
            ...
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <select v-model="newIncome.frequency"
                  class="w-full px-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none appearance-none bg-white">
              ...
              <div>
                ...
                <input v-model="newIncome.effectiveDate" type="date"
                  class="w-full px-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
                  required />
              </div>
            </div>
      ...
      <!-- Edit Income Modal -->
      <IncomeEdit v-if="showEditModal && editingIncome" :income="editingIncome" @close="closeEditModal"
        @saved="onIncomeSaved" />
    </div>
  </MainLayout>
</template>
